...
**Stand:** 07.02.2026  
**Status:** **Erledigt (Prio 1–3 + Punkt 3 + 4 + 5 umgesetzt).**
...
- **Punkt 3 (Tabs/Struktur):** **Erledigt** – Kunden-Detail mit Tabs „Stammdaten“ | „Termine & Tour“; Tab-Inhalte in eigene Dateien: [CustomerDetailStammdatenTab.kt](app/src/main/java/com/example/we2026_5/ui/detail/CustomerDetailStammdatenTab.kt), [CustomerDetailTermineTab.kt](app/src/main/java/com/example/we2026_5/ui/detail/CustomerDetailTermineTab.kt). Save-Button in TopBar bei Bearbeitung.
- **Punkt 4 (Monatliche Wochentags-Termine):** **Erledigt** – Regeltyp, Datenmodell, Berechnung + UI: [MonthlyWeekdayRuleContent.kt](app/src/main/java/com/example/we2026_5/ui/common/MonthlyWeekdayRuleContent.kt), [AddMonthlyIntervallSheet.kt](app/src/main/java/com/example/we2026_5/ui/detail/AddMonthlyIntervallSheet.kt) (eigene Dateien, keine Aufblähung bestehender Dateien).
- **Punkt 5 (Denormalisierung):** **Erledigt** – Knoten `customers_for_tour`, Sync bei save/update/delete, TourPlanner nutzt `getCustomersForTourFlow()`, einmaliger Backfill beim ersten Abruf.
...
- **Punkt 1, 2, 3, 4, 5, 6.2, 6.4:** Umgesetzt.
- **Punkt 3:** Tabs „Stammdaten“ | „Termine & Tour“, Tab-Inhalte in eigene Dateien, Save in TopBar.
- **Punkt 4 UI:** Button „Monatlichen Termin hinzufügen“ in TerminRegelCard, Sheet (eigene Dateien).

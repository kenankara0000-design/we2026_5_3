...
**Stand:** 07.02.2026  
**Status:** **Erledigt (Prio 1–3 + Punkt 5 umgesetzt).** Punkt 3, 4 für spätere Phasen offen.
...
- **Prio 4–5 (spätere Phasen):** Punkt 3 (Tabs/Struktur), Punkt 4 (monatliche Termine) – konzeptionell festgehalten.
...
- **Punkt 1, 2, 5, 6.2, 6.4:** Umgesetzt.
- **Punkt 3, 4:** Für spätere Phasen (Tabs/Struktur, monatliche Termine).

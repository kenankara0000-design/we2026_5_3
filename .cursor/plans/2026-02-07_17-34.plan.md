...
**Stand:** 07.02.2026  
**Status:** **Erledigt (Prio 1–3 + Punkt 4 + 5 umgesetzt).** Punkt 3 für spätere Phasen offen.
...
- **Prio 4 (spätere Phase):** Punkt 3 (Tabs/Struktur) – konzeptionell festgehalten.
...
- **Punkt 1, 2, 4, 5, 6.2, 6.4:** Umgesetzt.
- **Punkt 3:** Für spätere Phase (Tabs/Struktur).
- **Punkt 4 UI:** Erledigt – Button „Monatlichen Termin hinzufügen“ in TerminRegelCard, Sheet mit Woche im Monat + Wochentag (eigene Dateien).

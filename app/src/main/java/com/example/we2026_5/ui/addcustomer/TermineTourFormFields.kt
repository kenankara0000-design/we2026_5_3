...
/**
 * Gemeinsame Felder für Termine & Tour (Kundenart, T.-Typ, Startdatum, Intervall, Wochentage, Weitere Angaben).
 * Phase C1: Wiederverwendet in [CustomerDetailTermineTourForm] und [CustomerStammdatenForm] (bei showTermineTourSection).
 */
@Composable
fun TermineTourFormFields(
    ...
    /** Wenn true, wird im Bereich „Weitere Angaben“ zuerst das Koordinaten-Feld angezeigt (z. B. Stammdaten-Form). */
    includeCoordinatesInWeitereAngaben: Boolean = false
) {
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        ExpandableSection(
            ...
            if (includeCoordinatesInWeitereAngaben) {
                OutlinedTextField(
                    value = when {
